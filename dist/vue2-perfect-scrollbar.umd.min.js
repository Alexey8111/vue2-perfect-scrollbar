!(function (t, e) {
  ...
  function w(t, e) {
    ...
    i.contains(r) ? clearTimeout(o[e]) : i.add(r);
  }
  function Y(t, e) {
  ...
  (r.prototype.bind = function (t, e) {
    ...
    (r.prototype.unbind = function (e, i) {
      ...
      this.handlers[e] = this.handlers[e].filter(function (t) {
        return (
          !(!i || t === i) || (r.element.removeEventListener(e, t, !1), !1)
        );
      });
    }),
  ...
  function h(i, t) {
    ...
    function g() {
      Y(i, c),
        i[h].classList.remove(m.state.clicking),
        i.event.unbind(i.ownerDocument, "mousemove", b);
    }
    function v(t, e) {
      (d = u[a]),
        e && t.touches && (t[l] = t.touches[0].pageY),
        (p = t[l]),
        (f = (i[n] - i[r]) / (i[o] - i[s])),
        e
          ...
          : (i.event.bind(i.ownerDocument, "mousemove", b),
            ...
            t.preventDefault()),
        i[h].classList.add(m.state.clicking),
        t.stopPropagation();
    }
  ...
  var W = {
      ...
      keyboard: function (l) {
        var o = l.element;
        l.event.bind(l.ownerDocument, "keydown", function (t) {
          if (
            !(
            ...
            (s(o, ":hover") ||
              s(l.scrollbarX, ":focus") ||
              s(l.scrollbarY, ":focus"))
          ) {
            var e,
              i = document.activeElement
                ? document.activeElement
                : l.ownerDocument.activeElement;
            if (i) {
            ...
            switch (t.which) {
              ...
              case 40:
                ...
                break;
              case 32:
                n = t.shiftKey ? l.containerHeight : -l.containerHeight;
                break;
              case 33:
                n = l.containerHeight;
                break;
            ...
            (l.settings.suppressScrollX && 0 !== r) ||
              (l.settings.suppressScrollY && 0 !== n) ||
              ((o.scrollTop -= n),
              (o.scrollLeft += r),
              X(l),
              (function (t, e) {
                ...
                if (0 === e) {
                  ...
                  if (
                    (0 === r && t < 0) ||
                    (r >= l.contentWidth - l.containerWidth && 0 < t)
                  )
                    return !l.settings.wheelPropagation;
                }
                return !0;
        ...
        function t(t) {
          var e,
            ...
            n =
              ...
              (r = -1 * e.deltaY),
              (void 0 !== i && void 0 !== r) ||
                ((i = (-1 * e.wheelDeltaX) / 6), (r = e.wheelDeltaY / 6)),
              e.deltaMode && 1 === e.deltaMode && ((i *= 10), (r *= 10)),
              i != i && r != r && ((i = 0), (r = e.wheelDelta)),
              e.shiftKey ? [-r, -i] : [i, r]),
            l = n[0],
            o = n[1];
          if (
            !(function (t, e, i) {
              if (!y.isWebKit && g.querySelector("select:focus")) return !0;
              if (!g.contains(t)) return !1;
              for (var r = t; r && r !== g; ) {
                if (r.classList.contains(m.element.consuming)) return !0;
                var n = v(r);
                if (i && n.overflowY.match(/(scroll|auto)/)) {
                  var l = r.scrollHeight - r.clientHeight;
                  if (
                    0 < l &&
                    ((0 < r.scrollTop && i < 0) || (r.scrollTop < l && 0 < i))
                  )
                    return !0;
                }
                if (e && n.overflowX.match(/(scroll|auto)/)) {
                  var o = r.scrollWidth - r.clientWidth;
                  if (
                    0 < o &&
                    ((0 < r.scrollLeft && e < 0) || (r.scrollLeft < o && 0 < e))
                  )
                    return !0;
                }
                r = r.parentNode;
            ...
            b.settings.useBothWheelAxes
              ? b.scrollbarYActive && !b.scrollbarXActive
                ? (o
                    ...
                    : (g.scrollTop += l * b.settings.wheelSpeed),
                  (f = !0))
                : b.scrollbarXActive &&
                  !b.scrollbarYActive &&
                  (l
                    ? (g.scrollLeft += l * b.settings.wheelSpeed)
              ...
              (f =
                ...
                (d = 0 === g.scrollLeft),
                (p = g.scrollLeft + g.offsetWidth === g.scrollWidth),
                !(Math.abs(a) > Math.abs(s) ? h || u : d || p) ||
    ...
    u = function (t, e) {
      ...
      for (var r in ((this.element = t).classList.add(m.main),
      (this.settings = {
      ...
      (this.isRtl = "rtl" === v(t).direction),
        !0 === this.isRtl && t.classList.add(m.rtl),
        ...
        (this.scrollbarXRail = p(m.element.rail("x"))),
        t.appendChild(this.scrollbarXRail),
        (this.scrollbarX = p(m.element.thumb("x"))),
      ...
      (this.scrollbarXBottom = parseInt(a.bottom, 10)),
        ...
        (this.scrollbarYRail = p(m.element.rail("y"))),
        t.appendChild(this.scrollbarYRail),
        (this.scrollbarY = p(m.element.thumb("y"))),
    ...
    methods: {
      create: function () {
        (this.ps && this.$isServer) ||
          (this.ps = new u(this.$refs.container, this.options));
      },
  ...
  function R(t, e) {
    e &&
      (e.name && "string" == typeof e.name && (L.name = e.name),
      e.options &&
        "object" == typeof e.options &&
        (L.props.options.default = function () {
          return e.options;
        }),
      e.tag && "string" == typeof e.tag && (L.props.tag.default = e.tag),
      e.watchOptions &&
        "boolean" == typeof e.watchOptions &&
        (L.props.watchOptions = e.watchOptions)),
      t.component(L.name, L);
  }
  (t.install = R),
    (t.PerfectScrollbar = L),
    (t.default = R),
